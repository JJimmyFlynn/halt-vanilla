...
/** 
 * These hooks inform WP that Halt's required theme file are located in the 'views'
 * directory (excepting style.css, functions.php, and index.php) index.php
 */
...
$halt_includes = [
  ...
  'lib/bem-nav-walker.php'     // Navwalker with BEM syntax
];
